...
export default {
  ...
  methods: {
    createAsset() {
      ...
      this.selectedModels = this.selectedModels.map(
        ({ unique_id }) => unique_id
      )
      ...
      formData.append(
        'min_ownership_per_square_meter',
        this.minimumOwnershipPerSquareMeter
      )
